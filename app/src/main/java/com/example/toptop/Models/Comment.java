...
public class Comment {
    String cID,comment,user_id,user_name,time_comment,image_user,heart_comment,video_id;

    public Comment(String cID, String comment, String user_id, String user_name,String time_comment,String image_user,String heart_comment,String video_id) {
        this.cID = cID;
