...
public class Create_Fragment extends Fragment {
    ...
    private Button btupload_videi,bt_upEdit_video;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        bt_upEdit_video=view.findViewById(R.id.bt_uploadvideoEdit);
        ...
        editvideofromprofile();
        return view;
    }

    private void editvideofromprofile() {
        Bundle bundle3 = getArguments();
        if (bundle3 != null) {
            MediaObjectt media3 = (MediaObjectt) bundle3.get("MediaObjectt3");
            if (media3 != null) {
                pickvideoFab.setVisibility(View.INVISIBLE);
                bt_upEdit_video.setVisibility(View.VISIBLE);
                btupload_videi.setVisibility(View.INVISIBLE);
                eddess.setText(media3.getVideo_des());
                videoViewpost.setVideoPath(media3.getVideo_uri());
                ...
                bt_upEdit_video.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        des = eddess.getText().toString().trim();
                        if (TextUtils.isEmpty(des)) {
                            ...
                            DatabaseReference myrefeee = database.getReference("videos").child(media3.getVideo_id());
                            myrefeee.child("video_des").setValue(des);
                            myrefeee.child("hast_task_name").setValue("" + hast_task);
